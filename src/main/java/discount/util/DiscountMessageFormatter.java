...
public final class DiscountMessageFormatter {
    ...
    public static String applied(String discountCode, BigDecimal originalTotal, BigDecimal discountedTotal) {
    ...
    public static String failed(String discountCode, Exception e) {
        return String.format("[Discount] Code '%s' could not be applied: %s", discountCode, e.getMessage());
    }
}
