...
class CustomerServiceTest {
    ...
    void shouldCreateCustomer() {
        ...
        CustomerDto result = customerService.createCustomer(new CreateCustomerRequest("Jan Kowalski", EMAIL, PASSWORD));
    ...
    void shouldThrowWhenEmailAlreadyRegistered() {
        when(customerRepository.findByEmail(EMAIL)).thenReturn(
            Optional.of(new Customer(1L, "Existing", EMAIL, PASSWORD))
        );

        assertThrows(EmailAlreadyInUseException.class, () ->
            customerService.createCustomer(new CreateCustomerRequest("New Name", EMAIL, PASSWORD))
        );
    ...
    void shouldGetAllCustomers() {
        when(customerRepository.getAll()).thenReturn(
            List.of(
    ...
    void shouldAllowUpdateKeepingSameEmail() {
        ...
        CustomerDto result = customerService.updateCustomer(1L, new UpdateCustomerRequest("Jan Nowak", EMAIL));
    ...
    void shouldThrowWhenUpdatingToEmailAlreadyTakenByAnotherCustomer() {
        ...
        assertThrows(EmailAlreadyInUseException.class, () ->
            customerService.updateCustomer(1L, new UpdateCustomerRequest("Jan Nowak", "anna@example.com"))
        );
    }
    ...
    void shouldThrowWhenUpdatingNonExistentCustomer() {
        ...
        assertThrows(CustomerNotFoundException.class, () ->
            customerService.updateCustomer(99L, new UpdateCustomerRequest("Jan", EMAIL))
        );
    }
    ...
    void shouldThrowWhenChangingPasswordWithWrongCurrentPassword() {
        ...
        assertThrows(InvalidCredentialsException.class, () ->
            customerService.changePassword(1L, new ChangePasswordRequest("wrongPassword", "NewPassword456"))
        );
        verify(customerRepository, never()).save(any());
    }
