...
class CustomerValidatorTest {
    ...
    void shouldPassValidateName() {
        assertThatCode(() -> CustomerValidator.validateName("Anna Nowak")).doesNotThrowAnyException();
    }
    ...
    void shouldThrowValidateNameWhenBlankOrNull(String name) {
        assertThatExceptionOfType(InvalidProductException.class).isThrownBy(() -> CustomerValidator.validateName(name));
    }
}
