...
class ShopIT {
    ...
    void shouldCreateAndRetrieveComputer() {
        ComputerDto created = productFacade.createComputer(
    ...
    void shouldCreateAndRetrieveSmartphone() {
        SmartphoneDto created = productFacade.createSmartphone(
        ...
        assertThat(fetched.smartphoneConfiguration().accessories()).containsExactlyInAnyOrder(
            Accessory.CHARGER,
    ...
    void shouldRejectQuantityExceedingStock() {
        ...
        assertThatExceptionOfType(InsufficientStockException.class).isThrownBy(() ->
            cartService.addProduct(customer.id(), limited.id(), ProductType.ELECTRONICS, 5)
        );
    }
    ...
    void shouldNotReturnDeactivatedDiscount() {
        ...
        DiscountDto toDeactivate = discountService.createDiscount(
            new CreateDiscountRequest(
                "INACTIVE",
                "Deactivated",
                DiscountType.PERCENTAGE,
    ...
    void shouldHandleMixedCartWithComputerAndSmartphone() {
        ...
        ComputerDto computer = productFacade.createComputer(
            new CreateComputerRequest(
                "MacBook Pro",
                new BigDecimal("6000"),
                3,
        ...
        SmartphoneDto phone = productFacade.createSmartphone(
            new CreateSmartphoneRequest(
                "iPhone 15",
                new BigDecimal("4500"),
                5,
    ...
    void shouldReturnFailureForCustomerWithEmptyCart() {
        ...
        List<OrderProcessingResult> results = orderFacade.processBatchOrders(List.of(withCart, withoutCart.id()));
    ...
    private long createCustomerWithProduct(String name, Long productId, int quantity) {
        ...
        CustomerDto customer = customerService.createCustomer(new CreateCustomerRequest(name, email, "Password!123"));
