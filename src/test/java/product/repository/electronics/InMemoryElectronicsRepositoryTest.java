...
class InMemoryElectronicsRepositoryTest {
    ...
    void shouldFindElectronicsById() {
        ...
        repository.save(electronics);
        Optional<Electronics> result = repository.findById(1L);
    ...
    void shouldReturnEmptyWhenElectronicsNotFound() {
        Optional<Electronics> result = repository.findById(99L);
    ...
    void shouldReturnAllElectronics() {
        repository.save(new Electronics(repository.getNextId(), "Monitor 4K", BigDecimal.valueOf(1500), 10));
        repository.save(new Electronics(repository.getNextId(), "Keyboard", BigDecimal.valueOf(300), 25));
        repository.save(new Electronics(repository.getNextId(), "Headphones", BigDecimal.valueOf(500), 15));
